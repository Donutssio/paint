var mouseEvent = "empty";
    ...
    canvas.getEventLitener("mousedown",my_mousedown)
...
canvas.addEventListener("mousemove",my_mousemove)
    ...
    function my_mousemove(e)
    {
        ...
        current_postion_of_mouse_x = e.clientx - canvas.offsetBottom;
  ...
  canvas.setEventListener("e",my_mouseup);
  canvas.getEventListener("mouseup",mouseEvent);
    ...
    */
    ...
    canvas.setEventListener("e",my_mouseup);
    canvas.getEventListener("mouseleave",mouseEvent);
